...
class EnhancedChoreographyGenerator:
    """增强编舞生成器"""
    ...
    def generate_choreography_from_file(self, file_path: str) -> Dict:
        ...
        try:
            ...
            result = {
                ...
                'generation_method': 'enhanced_structured'
            }
    ...
    def get_action_database_info(self) -> Dict:
        """获取动作数据库信息"""
        return {
            'available_styles': list(get_action_candidates('Hip-Hop', 1).keys()) if hasattr(get_action_candidates, '__call__') else ['Hip-Hop', 'House', 'K-pop', 'Jazz', 'Contemporary', 'Breaking'],
